...
public class AddUserForm extends javax.swing.JDialog {
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        ...
        if(documentType ==0)
            documentTypeN= "Cédula de ciudadania";
        else if(documentType ==1)
            documentTypeN= "Cédula Extranjera";
        else if(documentType ==2)
            documentTypeN= "Libre Militar";
        ...
        if (name.isEmpty() || lastname.isEmpty() || document.isEmpty() || email.isEmpty()) {
            ...
            String queryNuevoEmpleado = 
                    "INSERT INTO `empleado`(`nombreEmpleado`, `apellidos`, `tipoDocumento`, `documento`, `correo`, `FK_idSucursal`) VALUES ('" 
