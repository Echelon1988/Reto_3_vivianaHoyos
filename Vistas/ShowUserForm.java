...
public class ShowUserForm extends javax.swing.JDialog {
    ...
    public void ActualizarEmpleado(){
        ...
        if(nombres.isEmpty()) {
            JOptionPane.showMessageDialog(this,  "El campo nombre es requerido", "", JOptionPane.WARNING_MESSAGE);
        }else if(apellidos.isEmpty()){
            JOptionPane.showMessageDialog(this,  "El campo apellido es requerido", "", JOptionPane.WARNING_MESSAGE);
        }else if(correo.isEmpty()){
            JOptionPane.showMessageDialog(this,  "El campo correo es requerido", "", JOptionPane.WARNING_MESSAGE);
        }else {
            String query = "UPDATE `empleado` SET `nombreEmpleado`='" + nombres + "',`apellidos`='" + apellidos + "',`correo`='" + correo + "'WHERE idEmp = " + idEmp +";";
